...
const styles = StyleSheet.create({
  ...
  imagePickerButton: { minHeight: 48, borderWidth: 1, borderStyle: 'dashed', borderRadius: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingHorizontal: 14 },
  pushImagePreview: { width: 150, height: 110, marginTop: 10 },
  pushImage: { width: '100%', height: '100%', borderRadius: 10, resizeMode: 'cover' },
  imageRemoveButton: { position: 'absolute', top: 6, right: 6, width: 26, height: 26, borderRadius: 13, alignItems: 'center', justifyContent: 'center' },
