...
export default function ProfileScreen() {
  ...
  const menu = [
    ...
    { icon: 'help-circle' as const, title: isArabic ? 'مركز المساعدة' : 'Help center', value: '', onPress: () => Alert.alert('Moqawil Help', 'Call +968 7722 4535 or email moqawil.om@gmail.com.') },
     { icon: 'shield' as const, title: isArabic ? 'لوحة الإدارة' : 'Admin console', value: !isSignedIn ? (isArabic ? 'سجّل الدخول للمتابعة' : 'Sign in to continue') : isAdmin ? (isArabic ? 'المقاولون والتقييمات' : 'Contractors & evaluations') : (isArabic ? 'تتطلب صلاحية المدير' : 'Admin role required'), onPress: () => router.push(isSignedIn ? '/admin' : '/sign-in') },
